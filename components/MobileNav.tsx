            ...
            <SheetContent side="left" className="border-none bg-white">
                <Link href="/" className="cursor-pointer items-center gap-1 px-4 flex">
                    ...
                    <Image 
                        ...
                        alt="Horizon logo"
                    />
                    <h1 className="text-26 font-ibm-plex-serif font-bold text-black-1">Moneta</h1>
                </Link>
                {/* Creates mobile nav and "SheetClose" means the hamburger menu closes when clicked anywhere. */}
